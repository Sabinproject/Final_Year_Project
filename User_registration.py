...
from kivy.uix.label import Label  # Import Label directly from kivy.uix
from kivy.uix.textinput import TextInput# Import TextInput directly from kivy.uix
...
class RegistrationApp(App):
    def build(self):
        ...
        head_label = Label(text="lost&Found user Registration App", font_size=26, bold=True, height=40)
        # Adding Label
